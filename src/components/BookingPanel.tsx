...
function Card({label,value,highlight=false}:{label:string;value:string|number;highlight?:boolean;}){
  return(
    <div className={['w-full max-w-full overflow-visible rounded-2xl p-4 flex flex-col justify-between',
      ...
      <div className={[highlight
        ?'text-[clamp(22px,7vw,28px)] md:text-[clamp(22px,2.2vw,34px)] text-orange-200'
